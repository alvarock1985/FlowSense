...
describe('Sensor API:', function() {
  ...
  describe('POST /api/sensors', function() {
    ...
    it('should respond with the newly created sensor', function() {
      expect(newSensor.name).to.equal('New Sensor');
      expect(newSensor.info).to.equal('This is the brand new sensor!!!');
    });
  });
  ...
  describe('GET /api/sensors/:id', function() {
    ...
    it('should respond with the requested sensor', function() {
      expect(sensor.name).to.equal('New Sensor');
      expect(sensor.info).to.equal('This is the brand new sensor!!!');
    });
  });
  ...
  describe('PUT /api/sensors/:id', function() {
    ...
    it('should respond with the updated sensor', function() {
      expect(updatedSensor.name).to.equal('Updated Sensor');
      expect(updatedSensor.info).to.equal('This is the updated sensor!!!');
    });
    ...
    it('should respond with the updated sensor on a subsequent GET', function(done) {
      request(app)
        ...
        .end((err, res) => {
          ...
          expect(sensor.name).to.equal('Updated Sensor');
          expect(sensor.info).to.equal('This is the updated sensor!!!');
  ...
  describe('PATCH /api/sensors/:id', function() {
    ...
    it('should respond with the patched sensor', function() {
      expect(patchedSensor.name).to.equal('Patched Sensor');
      expect(patchedSensor.info).to.equal('This is the patched sensor!!!');
    });
  });
